...
namespace FakeUp
{
    public interface IFakeUpConfig<TFakeObject>
    {
        ...
        */
        ...
        IFakeUpConfig<TFakeObject> WithConfigurations<T>(params Action<IFakeUpConfig<T>>[] configs);

        IFakeUpConfig<TFakeObject> WithConfigurations<T>(IEnumerable<Action<IFakeUpConfig<T>>> configs);
    }
}